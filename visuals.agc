...
function LoadAboutScreenTexts ( )
	...
	AddAboutScreenText("Desktop Code Name: ''BumbleBee''", 255)
	AddAboutScreenText("Genuine ''Kubuntu 18.04 L.T.S. 64Bit'' Linux", 255)
	AddAboutScreenText("BESTEC® 300watt Power Supply", 255)
	AddAboutScreenText("ASRock® Q1900M Motherboard", 255)
	AddAboutScreenText("Intel® Celeron 2.0GHz(2.44GHz Turbo) 4-Core CPU", 255)
	AddAboutScreenText("Corsair® 16GB DDR3 RAM Memory", 255)
	AddAboutScreenText("nVidia® GeForce GTX 750 Ti 2GB GDDR5 GPU", 255)
	AddAboutScreenText("Samsung® 500GB SSD Hard Drive(OS/Apps)", 255)
