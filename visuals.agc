...
function LoadAboutScreenTexts ( )
	...
	AddAboutScreenText("''Mortal Pongbat 110%''", 0)
	AddAboutScreenText("©2020 By Team Fallen Angel Software", 255)
	AddAboutScreenText("www.FallenAngelSoftware.com", 255)
	AddAboutScreenText("Made With ''AppGameKit''", 0)
	AddAboutScreenText("(Classic Or Studio)", 255)
	AddAboutScreenText("(www.AppGameKit.com)", 255)
	AddAboutScreenText("Game Built On:", 0)
	AddAboutScreenText("Genuine ''openSUSE Tumbleweed K.D.E. 64Bit'' Linux", 255)
	AddAboutScreenText("(www.openSUSE.org)", 255)
	...
	AddAboutScreenText("''Mortal Pongbat 110%'' Logo Created In:", 0)
	...
	AddAboutScreenText("Desktop Code Name: ''JetFire''", 255)
	AddAboutScreenText("Genuine ''openSUSE Tumbleweed K.D.E. 64Bit'' Linux", 255)
	AddAboutScreenText("Thermaltake® 500watt Power Supply", 255)
	AddAboutScreenText("Gigabye® Mid-Range Motherboard", 255)
	AddAboutScreenText("Intel® Core i5 3.0GHz(3.2GHz Turbo) 4-Core CPU", 255)
	AddAboutScreenText("Corsair® 16GB DDR3 RAM Memory", 255)
	AddAboutScreenText("nVidia® GeForce GTX 1050 Ti 4GB GDDR5 GPU", 255)
	...
	AddAboutScreenText("''JosephB''", 255)
	AddAboutScreenText("''psychoanima''", 255)

	AddAboutScreenText(" ", 255)
	
	AddAboutScreenText("''swivel''", 255)
	AddAboutScreenText("''EvanR''", 255)
	AddAboutScreenText("''demonicmaniac3''", 255)
